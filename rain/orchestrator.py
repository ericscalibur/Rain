...
class MultiAgentOrchestrator:
    ...
    def _build_reflection_prompt(self, query: str, primary_response: str) -> str:
        ...
        return (
            ...
            f"  VERDICT: PASS        — response is accurate, honest about what it knows, and answers the question. Brief is fine. Synthesis will NOT run.\n"
            ...
            f"  VERDICT: FAIL        — response is factually wrong, names tools/products/dependencies that do not exist, "
            f"claims to have analyzed content it never saw, or does not answer the question at all.\n\n"
            f"Hard rules:\n"
            f"  • A brief but correct answer is PASS. A long correct answer is also PASS.\n"
            f"  • An honest \"I don't know\" or \"I can't access that\" is PASS, not an error — "
            f"it beats an invented answer.\n"
            ...
            f"  • If the response recommends a fabricated tool or product, that is FAIL — "
            f"do not treat the fabrication as real and critique its details.\n"
